      ...
      <div className="container mx-auto px-4 pt-5 pb-24 max-w-md">
        ...
        {currentStep === JoinStep.INVITATION && (
          <div className="flex flex-col space-y-8">
            <div className="text-center">
              ...
              {unionData.intro && (
                <p className="text-gray-500 mb-6">{unionData.intro}</p>
              )}
            </div>
        ...
        {currentStep === JoinStep.CONFIRM && selectedGroups.length > 0 && (
          <div className="flex flex-col space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
              <h3 className="font-medium text-gray-900 mb-4">공동체 정보</h3>
              <p className="text-gray-800 font-medium">{unionData.name}</p>
              <p className="text-gray-600 text-sm">
                {unionData.church || "교회 정보 없음"}
              </p>
              {unionData.intro && (
                <p className="text-gray-500 text-sm mt-2">{unionData.intro}</p>
              )}

              <div className="my-4 border-t border-gray-200"></div>

              <h3 className="font-medium text-gray-900 mb-4">그룹 정보</h3>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    등록 후에는 공동체 관리자의 승인 없이 해당 그룹을 공동체에서
                    제외할 수 없습니다.
                  </p>
                </div>
              </div>

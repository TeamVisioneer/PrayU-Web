  ...
  return (
    <div className="w-full flex-grow flex flex-col items-center">
      <div className="relative flex flex-col w-[85%] flex-grow justify-center items-center max-h-[500px]">
        ...
        <div className="flex w-full flex-col flex-grow py-10 justify-center items-center text-center gap-6 border rounded-2xl shadow-prayCard bg-gradient-to-t from-[#FFF8F8] via-[#FFEBFA] via-41.75% to-[#AAC7FF] z-10 opacity-100">

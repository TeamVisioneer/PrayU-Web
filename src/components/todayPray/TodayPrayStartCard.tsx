...
interface OtherPrayCardNumberProps {
  otherPrayCardNumber: number;
}

export const TodayPrayStartCard: React.FC<OtherPrayCardNumberProps> = ({
  otherPrayCardNumber,
}) => {
  return (
    <>
      <div className="flex flex-col  gap-2 border p-4 rounded-lg shadow-md bg-white justify-center items-center h-60vh">
        <div className="text-center">
          ...
          <h1>{otherPrayCardNumber}명의 기도제목이</h1>

...
export const TodayPrayStartCard = () => {
  ...
  return (
    <>
      <div className="text-center flex flex-col gap-2 border rounded-2xl shadow-md bg-gradient-to-b from-start/40 via-middle/40 via-30% to-end/40 justify-center items-center w-6/7 h-60vh">

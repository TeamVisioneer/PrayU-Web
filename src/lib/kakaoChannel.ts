...
//   iOS     https://talk-apps.kakao.com/scheme/<enc(kakaoplus://plusfriend/chat/<id>)>&web=<폴백>
//   Android intent://plusfriend/chat/<id>#Intent;scheme=kakaoplus;package=com.kakao.talk;S.browser_fallback_url=<폴백>;end;
...
export const openKakaoChannelChat = () => {
  ...
  if (/android/.test(ua)) {
    window.location.href = [
      `intent://plusfriend/chat/${id}#Intent`,
      "scheme=kakaoplus",
  ...
  const scheme = `kakaoplus://plusfriend/chat/${id}`;

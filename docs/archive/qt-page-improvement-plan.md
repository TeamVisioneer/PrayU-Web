...
- 절 범위: **두 탭 방식** — 첫 탭 = 시작(단일 절), 이후 더 큰 절 탭 = 끝 절 확장, 아무 절이나 다시 탭 = 새 시작
- **범위 상한: 장 전체** (2026-07-27 사용자 결정으로 20절 상한 폐기) — "끝절까지" 선택이 필요하며, 장이 자연스러운 묵상 단위이자 상한. 절 열 sticky 헤더에 상태 안내("시작 절" → "~ 끝 절")와 **"끝절까지" 단축 버튼**(시작 절 선택 후 활성, 탭 시 끝 절 = 장의 마지막 절)을 둔다
